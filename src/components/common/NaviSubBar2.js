...
class NaviSubBarTwo extends Component {
  render() {
    return (
      ...
      <View style={styles.bar3}>
        <TouchableOpacity
          ...
          <View style={styles.indexbar}>
            ...
            <View style={styles.inner}>
              <Text style={{ fontSize: 15, textAlign: 'center', color: this.props.order == "1st"?color.main1C:color.black2C }}>待派单</Text>
            </View>
            <View style={styles.innerother}>
        ...
        <TouchableOpacity
          ...
          <View style={styles.indexbar}>
            ...
            <View style={styles.inner}>
              <Text style={{ fontSize: 15, textAlign: 'center', color: this.props.order == "2st"?color.main1C:color.black2C }}>维修中</Text>
            </View>
            <View style={styles.innerother}>
