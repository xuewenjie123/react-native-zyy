...
export default class SwiperBoxboutique extends Component {
      ...
      <View style={styles.image} pointerEvents={"box-none"}>
        <Swiper {...SwiperProps}>
          {_props.imglist.map((d,index)=>(
            <TouchableHighlight key={index} style={styles.slide} onPress={()=>{_this.onpushRouter(d.complexId_,d.kind)}}>
